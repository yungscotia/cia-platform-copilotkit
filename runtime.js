...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = require('./CopilotKit/packages/runtime/dist/index.js');
}

// For ES Module environments
export default async function getRuntimeModule() {
  const module = await import('./CopilotKit/packages/runtime/dist/index.js');
